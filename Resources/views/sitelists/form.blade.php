...
{!!
    Form::open([
        'url' => isset($sitelist)
            ? route('sitelists.update', $sitelist->id)
            : route('sitelists.store'),
        'method' => 'POST'
    ])
!!}
...
<div class="page-bar">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <a href="{{route('sitelists.index')}}" class="btn btn-default">
                    ...
                    <div class="actions-dropdown">
                      <a href="#" class="dropdown-toggle btn btn-default" data-toggle="dropdown" aria-expanded="false">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right default-padding">
                            ...
                            @if(isset($sitelist))
                            <li>
                                <a href="#" id="general-delete-btn" class="text-danger" data-redirection="{{route('sitelists.index')}}" data-ajax="{{route('sitelists.delete',$sitelist)}}">
  ...
  {{-- SIDEBAR --}}
      <div class="sidebar">
          ...
          <div class="form-group">
              {!!
                  Form::open([
                      'url' => route('sitelists.delete', $sitelist->id),
                      'method' => 'POST',
...
@push('javascripts')
    ...
    {{ Html::script('/modules/architect/js/tools/app.js') }}
    {{ Html::script('/modules/architect/js/tools/app.sitelist.js') }}
