                ...
                widgets.push(
                    <div className="col-xs-4" key={key}>
                        <a href="" onClick={this.addItem.bind(this, WIDGETS[key])}>
                            <div className="grid-item with-image"
                                 style={{backgroundImage: 'url(' + ASSETS + 'modules/turisme/images/widgets/' + WIDGETS[key]['label'].toLowerCase() + '.jpg)'}}>
                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-footer">
                            <a href="" className="btn btn-default"
                               onClick={this.onModalClose}> {Lang.get('fields.cancel')} </a> &nbsp;
                        </div>
